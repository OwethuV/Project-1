<template>
  <div class="attendance-system">
    ...
    <div class="search-box">
      <label for="employeeSearch">Search employee by name:</label>
    ...
    <!-- Toggle Button for Add Employee Form -->
    ...
    <!-- Add New Employee Form (conditionally shown) -->
...
<!-- <div v-if="!showAddEmployeeForm && !selectedEmployee && !selectedEmployeeId" class="employee-list">
  ...
  >
    <span @click="selectEmployee(employee)" style="flex: 1; cursor: pointer;">
      {{ employee.name }}
    </span>
    <button
      @click.stop="deleteEmployee(employee.employeeId)"
...
<div v-else class="employee-list"></div>
