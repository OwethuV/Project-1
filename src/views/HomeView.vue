...
<script>
import employeeInfo from '/LCA Code Work/02 - M1 - FrontEnd Web Development/Project week/Project-1/main/public/employee_info.json';
import attendanceData from '/LCA Code Work/02 - M1 - FrontEnd Web Development/Project week/Project-1/main/public/attendance.json';
import payrollData from '/LCA Code Work/02 - M1 - FrontEnd Web Development/Project week/Project-1/main/public/payroll_data.json';
